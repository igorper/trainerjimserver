class AddGuidanceInfoToExercise < ActiveRecord::Migration
  def change
    add_column :exercises, :duration_after_repetition, :decimal
    add_column :exercises, :duration_up_repetition, :decimal
    add_column :exercises, :duration_middle_repetition, :decimal
    add_column :exercises, :duration_down_repetition, :decimal
